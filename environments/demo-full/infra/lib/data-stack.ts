...
export class DataStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: DataStackProps) {
    ...
    cdk.Tags.of(this).add("Name", "smartretail-data-full");
    ...
    // Firehose ingest access key — used by SIS to validate Firehose HTTP deliveries
    ...
    // Events S3 bucket — Firehose S3 AllData backup
