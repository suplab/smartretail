...
# Demo-full stack: sc-planner only, served via CloudFront (HTTPS).
#
# Usage:
#   ./environments/demo-full/scripts/deploy-mfes-demo-full.sh [OPTIONS]
#
# Options:
...
#
# Examples:
#   ./environments/demo-full/scripts/deploy-mfes-demo-full.sh --env demo
#   ./environments/demo-full/scripts/deploy-mfes-demo-full.sh --env demo --skip-build
...
echo "=================================================="
echo " SmartRetail — Deploy MFEs (demo-full)"
echo " env:    ${ENV}"
echo " mfes:   ${MFES}"
echo "=================================================="
