...
class TraceIdFilterTest {
    ...
    void setsTraceIdFromHeader_inResponseHeader() throws Exception {
        ...
        req.addHeader("X-Amzn-Trace-Id", "trace-abc-123");
        MockHttpServletResponse resp = new MockHttpServletResponse();

        filter.doFilter(req, resp, chain);

        assertThat(resp.getHeader("X-Trace-Id")).isEqualTo("trace-abc-123");
    }
    ...
    void setsCorrelationIdFromHeader_inResponseHeader() throws Exception {
        MockHttpServletRequest req = new MockHttpServletRequest("GET", "/v1/test");
        req.addHeader("X-Correlation-ID", "corr-xyz-456");
        MockHttpServletResponse resp = new MockHttpServletResponse();

        filter.doFilter(req, resp, chain);

        assertThat(resp.getHeader("X-Correlation-ID")).isEqualTo("corr-xyz-456");
    }
    ...
    void clearsMdcAfterFilterChain() throws Exception {
        MockHttpServletRequest req = new MockHttpServletRequest("GET", "/v1/test");
        req.addHeader("X-Amzn-Trace-Id", "trace-clear-test");
        req.addHeader("X-Correlation-ID", "corr-clear-test");
        MockHttpServletResponse resp = new MockHttpServletResponse();
    ...
    void differentRequests_generateDistinctTraceIds() throws Exception {
        MockHttpServletRequest req1 = new MockHttpServletRequest("GET", "/v1/test");
        MockHttpServletResponse resp1 = new MockHttpServletResponse();
        filter.doFilter(req1, resp1, chain);
        String traceId1 = resp1.getHeader("X-Trace-Id");

        MockHttpServletRequest req2 = new MockHttpServletRequest("GET", "/v1/test");
