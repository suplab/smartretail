...
const flow8: FlowDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      activeNodes: [],
      checklist: [
        { id: 'v8-1', text: 'All 9 KPI fields non-null',            matchPattern: 'kpi' },
        { id: 'v8-2', text: 'EXECUTIVE role required',              matchPattern: 'EXECUTIVE' },
        { id: 'v8-3', text: 'dataFreshness within 5 minutes',       matchPattern: 'dataFreshness' },
        { id: 'v8-4', text: 'MAPE < 0.15 (healthy forecast)',       matchPattern: 'mape' },
      ],
    },
  ],
}
