...
const flow9: FlowDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      activeNodes: [],
      checklist: [
        { id: 'v9-1', text: 'All 8 tabs render data',               matchPattern: 'tab' },
        { id: 'v9-2', text: 'SC_PLANNER role enforced',             matchPattern: 'SC_PLANNER' },
        { id: 'v9-3', text: 'Replenishment trigger creates DRAFT',  matchPattern: 'DRAFT' },
        { id: 'v9-4', text: 'dataFreshness in all responses',       matchPattern: 'dataFreshness' },
      ],
    },
  ],
}
