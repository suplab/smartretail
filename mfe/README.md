...
| `supplier/`      | Supplier Portal         | 5177         | External supplier view — PO status, shipment tracking (SUPPLIER\_ADMIN role) |
...
cd mfe/supplier      && npm install && npm run dev   # → http://localhost:5177
```
