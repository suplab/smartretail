package com.smartretail.sis.architecture;
...
class ArchitectureTest {
    ...
    private static final String DOMAIN_PACKAGES = "com.smartretail.sis.domain..";
    private static final String PORT_PACKAGES = "com.smartretail.sis.port..";
    ...
    void adaptersMustNotDependOnEachOther() {
        ArchRule rule = noClasses()
                .that().resideInAPackage("com.smartretail.sis.adapter.inbound..")
                .should().dependOnClassesThat().resideInAPackage("com.smartretail.sis.adapter.outbound..");
        rule.check(classes);
    }
}
